    ...
    <div className="bg-gradient-to-br from-green-900 via-green-800 to-green-700 text-white sticky top-0 z-50 shadow-md">
      <div className="max-w-[760px] mx-auto px-4 py-3 flex items-center justify-between gap-2.5">
        <div className="flex items-center gap-2.5">
          <div className="bg-white text-green-800 text-sm font-black px-2.5 py-1 rounded-lg tracking-tight">
            MRA
          </div>
          <div>
            <h1 className={`text-sm font-bold leading-tight ${lang === 'ur' ? 'font-urdu' : ''}`}>
              {t.appTitle}
            </h1>
            <p className="text-[10px] opacity-70">{t.appSubtitle}</p>
          </div>
        </div>
